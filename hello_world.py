...
def credit_card_balance(num_rows = None, nan_as_category = True):
    ...
    cc.drop(columns=cat_cols,inplace = True)
    ...
    cc_agg = cc_agg.join(cat, how='left', on='SK_ID_CURR')
    del cc
    gc.collect()
    return cat,cc_agg,cat_cols

df,cat_cols = application_train_test()
#=df.head(10000)

cc_cat_v2,cc_agg_v2,cc_cat_col_v2 = credit_card_balance()
#cc_agg_v2 = cc_agg_v2.head(10000)
